...
class Nim():
    ...
    def __init__(self, initial=[1, 3, 5, 7]):
        """
        d.
        Each game board hasInitialize game boar
            - `philes`: a list of ow many elements remain in each pile
...
class NimAI():
    ...
    def update_q_value(self, state, action, old_q, reward, future_rewards):
        """
        Update lthe Q-value for the state `state` and the action `action`
        given the previous Q-vaue `old_q`, a current reward `reward`,
